        ...
        return function() {
            ...
            return h.prototype.buildTemplates = function() {
                ...
                h.prototype.setZoomEssentials = function() {
                    ...
                    this.imageYSize = typeof t.get() === 'undefined' ? 0 : this.getImageSize(t.get(), this.rotateValue, "y"),
                    this.imageXSize = typeof t.get() === 'undefined' ? 0 : this.getImageSize(t.get(), this.rotateValue, "x"),
                ...
                h.prototype.zoomIn = function(t) {
                    this.core.galleryItems[this.core.index].src && (t ? this.scale = t : this.scale += this.settings.scale,
                ...
                h.prototype.pinchZoom = function() {
                    ...
                    this.core.$inner.on("touchstart.lg", (function(o) {
                            ...
                            2 !== o.targetTouches.length || t.core.outer.hasClass("lg-first-slide-loading") || !t.$LG(o.target).hasClass("lg-item") && !s.get().contains(o.target) || (i = t.scale || 1,
                ...
                h.prototype.zoomSwipe = function() {
                    ...
                    this.core.$inner.on("touchstart.lg", (function(s) {
                            if (o.core.galleryItems[o.core.index].src && (g = o.core.getSlideItem(o.core.index),
                ...
                h.prototype.zoomDrag = function() {
                    ...
                    this.core.outer.on("mousedown.lg.zoom", (function(e) {
                            if (s.core.galleryItems[s.core.index].src) {
