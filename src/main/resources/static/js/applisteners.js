$("#appToolsBatchEdit").click(function(e) {
    ...
    for (let index in metadataThumbnailsArray) {
        ...
        thumbnailList += '<img src="'+metadataThumnailUrl+'" height="75" width="75" data-bs-toggle="tooltip" data-bs-placement="top" title="'+metadataFilenamesArray[index]+'" onError="shashin.errorImg(this,\''+metadataFilenamesArray[index]+'\')">';
    }
