(function( timelineSettings, $, undefined ) {
    ...
    timelineSettings.openTimelineModal = function(metadata,recognitionLabels,taggedPeopleList) {
        ...
        if (metadata.thumbnailUrlCentered !== null) {
            $("#propTimelineModalThumbnail").html('<img src="'+encodeURI(metadata.thumbnailUrlCentered)+'" height="100" width="100">');
        }
                    ...
                    if (data.hasOwnProperty("metadataList") &&
                        ...
                        if (metadataList.length > 0) {
                            ...
                            for (const index in metadataList) {
                                ...
                                html = '<img src="'+encodeURI(metadata.thumbnailUrlSmall)+'" class="photo-thumbnail-image" id="image'+metadata.id+'" width="'+metadata.thumbnailSmallWidth+'" height="'+metadata.thumbnailSmallHeight+'" style="background-color:lightgray;">';
