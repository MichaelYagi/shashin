    ...
    albumSettings.openAlbumModal = function (e,metadataId) {
        ...
        if (metadata !== null) {
            ...
            if (metadata.thumbnailUrlCentered !== null) {
                $("#propAlbumModalThumbnail").html('<img src="'+encodeURI(metadata.thumbnailUrlCentered)+'" height="100" width="100">');
            }
                        ...
                        if (albumMetadataList.length > 0) {
                            ...
                            for (const index in albumMetadataList) {
                                ...
                                let html =
                                    ...
                                    '   <img src="' + encodeURI(metadata.thumbnailUrlSmall) + '" class="photo-thumbnail-image" id="image' + metadata.id + '" width="' + metadata.thumbnailSmallWidth + '" height="' + metadata.thumbnailSmallHeight + '" style="background-color:lightgray;">\n';
