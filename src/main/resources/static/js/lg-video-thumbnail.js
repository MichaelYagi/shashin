            ...
            this.core.outer
                ...
                .on('click.lg', () => {
                    ...
                    if (typeof funObject.fn === 'function' && funObject.args !== null && funObject.args.length > 0) {
                        ...
                        if (shashin) {
                            shashin.showToastMessage("Could not capture screenshot", "Could not capture screenshot. Function or metadata ID not found", {icon:"bi-exclamation-triangle", forceDisplay: true, iconColor:"#FF0000", borderColor:"danger"});
                        }
