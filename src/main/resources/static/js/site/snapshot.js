class Snapshot {
    ...
    init() {
        ...
        $("#export").on("click", function() {
            ...
            shashin.showToastMessage("Exporting data", "Exporting metadata, albums and favorites", {icon:"bi-info-circle", forceDisplay: true, iconColor:"#777777", autohide:false});
            ...
            downloadTimer = window.setInterval( function() {
                ...
                if ((tokenCookieValue !== "" && tokenCookieSize !== "" && tokenCookieDbBackupName !== "") || attempts === 0) {
                    if (attempts === 0) {
                        ...
                        shashin.showToastMessage("Saving data", "Database backup name: " + dbBackupNameString + ". File name: " + tokenCookieValue + "; File size: " + Util.formatBytes(tokenCookieSize), {icon:"bi-info-circle", forceDisplay: true, iconColor:"#777777"});
