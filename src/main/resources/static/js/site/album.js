                        ...
                        for (let index in albumMetadataList) {
                            ...
                            if ($("#photoThumbnailContainer"+metadata.id).length === 0) {
                                ...
                                if ($("#"+currentDate).length === 0 && dateHeadingObj !== null) {
                                    const headerAndBody = '<section class="dateSection" id="'+dateHeadingObj.heading+'"><strong>'+dateHeadingObj.display+'</strong><div id="dateBody'+dateHeadingObj.heading+'" class="row mt-3" style="margin-left:-2px;"></div></section>';
