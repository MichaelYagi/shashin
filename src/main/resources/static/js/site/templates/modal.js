class ModalTemplates {
    static AlbumCommentsModalHead({metadata}) { return `
        <div class="modal fade no-justify" id="propalbumphotocomment${metadata.id}" tabindex="-1" role="dialog" aria-labelledby="label${metadata.id}">
