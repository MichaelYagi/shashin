        ...
        if (data !== null && data.hasOwnProperty("resultList")) {
            ...
            if (resultList !== null && resultList.length > 0) {
                for (const index in resultList) {
                    ...
                    html += 'style="max-height:225px;object-fit: scale-down;" class="photo-thumbnail-image" id="image'+resultObj["image_id"]+'">';
                    ...
                    if (resultObj["metadata_date"] != null && resultObj["metadata_date"] !== '') {
                        ...
                        html += '<a href="/timeline#' + resultObj["metadata_date"] + '" target="_blank"><span class="bi-play-circle" ';
