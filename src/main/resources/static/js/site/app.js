    ...
    shashin.matchingListeners = function () {
        ...
        $("#matchToolsBatchEdit").on("click", function(e) {
            ...
            if (metadataIdList.length > 5) {
                ...
                thumbnailList += '<span class="bi-arrow-left ms-1 me-1 display-6 align-middle"></span><span class="display-6 align-middle">'+(metadataIdList.length-5).toString()+'</span><span class="bi-arrow-right ms-1 me-1 display-6 align-middle"></span>';
