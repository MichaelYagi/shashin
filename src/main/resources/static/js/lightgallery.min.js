                ...
                s.prototype.keyPress = function() {
                    ...
                    i(window).on("keydown.lg.global" + this.lgId, (function(e) {
                        console.log("test");
                            ...
                            27 === e.keyCode && shashin.openedInfoFromLG === true && $("#metadataModalCancel").length > 0 && (e.preventDefault(), // press esc to close info modal
                                shashin.openedInfoFromLG = false,$("#metadataModalCancel").click())
                            )
                        }
                    ))
                }
