            ...
            return s.prototype.generateSettings = function(e) {
                ...
                s.prototype.updateSlides = function(t, e) {
                    ...
                    1 === t.length && (this.index = 0),
                        ...
                        if (typeof shashin !== 'undefined' && shashin.hasToast(shashin.toast.placement.bottom.center, {tag: "subhtml"})) {
                    ...
                    setTimeout((function() {
                            ...
                            t.settings.hideBarsDelay > 0 && (t.outer.on("mousemove.lg click.lg touchstart.lg", (function() {
                                    ...
                                    t.hideBarTimeout = setTimeout((function() {
                                            if (shashin.hasToast(shashin.toast.placement.bottom.center, {tag: "subhtml"}) === true) {
                                                shashin.closeToastMessages({tags: ["subhtml"]});
                                            }
                ...
                s.prototype.keyPress = function() {
                    ...
                    i(window).on("keydown.lg.global" + this.lgId, (function(e) {
                            ...
                            39 === e.keyCode && (e.preventDefault(),
                                t.goToNextSlide()),
                            73 === e.keyCode && $("#metadataDetail").length > 0 && (e.preventDefault(), // press i to bring up info modal
                ...
                s.prototype.invalidateItems = function() {
                    if (typeof shashin !== 'undefined' && shashin.hasToast(shashin.toast.placement.bottom.center, {tag: "subhtml"}) === false) {
                        shashin.closeToastMessages({tags:["subhtml"]});
                    }
                ...
                s.prototype.manageCloseGallery = function() {
                    if (typeof shashin !== 'undefined' && shashin.hasToast(shashin.toast.placement.bottom.center, {tag: "subhtml"}) === true) {
                        shashin.closeToastMessages({tags:["subhtml"]});
                    }
