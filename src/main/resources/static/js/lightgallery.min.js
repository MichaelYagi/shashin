        ...
        var o = function(t, e, s, n) {
            ...
            return s.prototype.generateSettings = function(e) {
                ...
                s.prototype.resizeVideoSlide = function(t, e) {
                    ...
                    var subString = "<br>";
                    subString += "";
                    if (subString.length <= 0) return (lgSubhtml.length + 1);
                    var pos = 0,
                    ...
                    } else if (lgSubhtml !== null && lgSubhtml !== "") {
                    ...
                    if (lgSize !== undefined && lgSize !== "" && $(".lg-inner").length > 0) {
                        ...
                        if (lgSizeArray.length > 1) {
                            ...
                            if (lgInnerHeight > 0 && height > lgInnerHeight) {
                                e.height = lgInnerHeight;
                                e.width = (width/height) * e.height;
                            }

                            if (lgInnerWidth > 0 && width > lgInnerWidth) {
                                e.width = lgInnerWidth;
