 ...
 * @license GPLv3
 * MY - Modified Oct 8 2023
 * - Maximize video screen based on lgSize property dimensions
 */
...
!function(t, e) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).lightGallery = e()
        ...
        var s = ["metadataId", "lgSize", "src", "sources", "subHtml", "subHtmlUrl", "html", "video", "poster", "slideName", "responsive", "srcset", "sizes", "iframe", "downloadUrl", "download", "width", "facebookShareUrl", "tweetText", "iframeTitle", "twitterShareUrl", "pinterestShareUrl", "pinterestText", "fbHtml", "disqusIdentifier", "disqusUrl"];
        function n(t) {
        ...
        var o = function(t, e, s, n) {
            ...
            if (o) {
                ...
                if (typeof r.get() === 'undefined') {
                    r = i(t.parentNode.parentNode).find("img").first();
                }
                if (r.get()) {
                    ...
                    var translate = "translate3d(" + (u *= -1) + "px, " + (m *= -1) + "px, 0) scale3d(" + d / o.width + ", " + h / o.height + ", 1)";
                    // console.log(a)
                    // console.log(g)
                    // console.log(d)
                    // console.log(h)
            ...
            mobileSettings: {
                controls: !1,
                showCloseIcon: !1,
                // download: !1 // Allow downloads on mobile
            },
            plugins: []
        }
            ...
            return s.prototype.generateSettings = function(e) {
                if (this.settings = t(t({}, m), e),
                    this.settings.isMobile && "function" == typeof this.settings.isMobile ? this.settings.isMobile() : u()) {
                ...
                s.prototype.openGalleryOnItemClick = function() {
                    for (var t = this, s = function(s) {
                        var o = n.items[s]
                            , r = i(o)
                            , l = e.generateUUID();
                        var mediaLink = document.getElementById("mediaLink"+r.attr("data-metadata-id"))
                        if (r.attr("data-metadata-id") !== "" && typeof(mediaLink) != 'undefined' && mediaLink != null && mediaLink.hasAttribute("data-lg-id") === false) {
                        ...
                        } else if (r.attr("data-metadata-id") !== "" && typeof(mediaLink) != 'undefined' && mediaLink != null && mediaLink.hasAttribute("data-lg-id") === true) {
                            l = r.attr("data-lg-id");
                            r.attr("data-lg-id", l).on("click.lgcustom-item-" + l, (function (e) {
                                    e.preventDefault();
                                    var i = t.settings.index || s;
                ...
                s.prototype.refreshOnResize = function() {
                    if (this.lgOpened) {
                        ...
                        var e = this.mediaContainerPosition
                            , i = e.top
                            , s = e.bottom;
                        if (this.currentImageSize = o(this.items[this.index], this.outer, i + s, t && this.settings.videoMaxSize),
                ...
                ,
                s.prototype.calculateFullscreen = function(t, L) {
                    // Size video correctly
                    var n = this.galleryItems[t];
                    var lgSubhtml = n.subHtml;
                    var lgSubhtmlSingleLineHeight = 0; //((typeof shashin !== 'undefined') ? 0 : 25); // Puts space for description
                    var lgSubhtmlHeight = 0;
                    var lgMarginBottom = 0;
                    var numOfLineBreak = 0;
                    L.marginTop = 0;

                    // Make space for subhtml so we don't block controls
                    var subString = "<br>";
                    subString += "";

                    if (lgSubhtml && lgSubhtml !== null && lgSubhtml !== "") {
                        var pos = 0;
                        var step = subString.length;
                        while (true) {
                            pos = lgSubhtml.toLowerCase().indexOf(subString, pos);
                            if (pos >= 0) {
                                ++numOfLineBreak;
                                pos += step;
                            } else break;
                    ...
                    let numOfLinesAdjustment = 1;

                    if (numOfLineBreak > 0) {
                        lgSubhtmlHeight = lgSubhtmlSingleLineHeight * (numOfLineBreak+numOfLinesAdjustment);
                    } else if (lgSubhtml && lgSubhtml !== null && lgSubhtml !== "") {
                        lgSubhtmlHeight = lgSubhtmlSingleLineHeight * numOfLinesAdjustment;
                    }

                    L.marginBottom = 0;
                    if (true === this.settings.allowMediaOverlap) {
                        L.marginBottom = lgSubhtmlHeight;
                    } else {
                        lgSubhtmlHeight *= 2;
                        if (lgSubhtmlHeight === 0) {
                            lgSubhtmlHeight = lgSubhtmlSingleLineHeight;
                            L.marginTop = 54;
                        } else if (lgSubhtmlHeight === (lgSubhtmlSingleLineHeight*2)) {
                            lgSubhtmlHeight = lgSubhtmlSingleLineHeight*4;
                        }
                    }

                    var lgSize = n.lgSize;

                    if (lgSize !== undefined && lgSize !== "" && $(".lg-inner").length > 0) {
                        var lgInnerHeight = $(".lg-inner").height();
                        var lgInnerWidth = $(".lg-inner").width();
                        if (lgSubhtml && lgSubhtml !== null && lgSubhtml !== "") {
                            lgInnerHeight = lgInnerHeight - lgSubhtmlHeight
                        }

                        var lgSizeArray = lgSize.split("-");
                        if (lgSizeArray.length > 1) {
                            var width = lgSizeArray[0];
                            var height = lgSizeArray[1];

                            if (L.height != height || L.width != width) {
                                L.height = height;
                                L.width = width;
                            }

                            if (lgInnerWidth > 0 && L.width > lgInnerWidth) {
                                L.width = lgInnerWidth;
                                L.height = (height / width) * L.width;
                            }

                            if (lgInnerHeight > 0 && L.height > lgInnerHeight) {
                                L.height = lgInnerHeight;
                                L.width = (width / height) * L.height;
                            }
                        }
                    }
                ...
                s.prototype.resizeVideoSlide = function(t, e) {
                    e = this.calculateFullscreen(t, e);
                ...
                s.prototype.openGallery = function(t, e) {
                    ...
                    if (void 0 === t && (t = this.settings.index),
                        ...
                        this.zoomFromOrigin && e && (this.currentImageSize = o(e, this.outer, d + h, this.galleryItems[t].__slideVideoInfo && this.settings.videoMaxSize),
                        ...
                        setTimeout((function() {
                            ...
                            setTimeout((function() {
                                    if (s.zoomFromOrigin && a) {
                                        ...
                                        e.css("transform", a),
                                            setTimeout((function() {
                                                    e.addClass("lg-start-progress lg-start-end-progress").css("transition-duration", s.settings.startAnimationDuration + "ms"),
                                    ...
                                    s.zoomFromOrigin && a || setTimeout((function() {
                ...
                s.prototype.hideBars = function() {
                    ...
                    // Clean up any previous toast hover listener
                    if (t._lgToastHoverHandler) {
                        document.getElementById("bottomCenterToastContainer").removeEventListener("mousemove", t._lgToastHoverHandler);
                        t._lgToastHoverHandler = null;
                    }
                            ...
                            if (t.settings.hideBarsDelay > 0) {
                                function resetHideTimer() {
                                    ...
                                    t.hideBarTimeout = setTimeout(function() {
                                        if (document.getElementById("bottomCenterToastContainer").matches(":hover")) {
                                ...
                                t.outer.on("mousemove.lg click.lg touchstart.lg", function() {
                                    if (typeof shashin !== 'undefined' && !t._lgToastShowPending && shashin.hasToast(shashin.toast.placement.bottom.center, {tag: "lgSubhtml"}) === false && t.lgOpened && t.galleryItems.length > 0) {
                                        t._lgToastShowPending = true;
                                        setTimeout(function() {
                                            if (t.lgOpened && t.galleryItems.length > 0) {
                                                let subhtml = t.galleryItems[t.index].hasOwnProperty("subHtmlUrl") ? t.galleryItems[t.index].subHtmlUrl : t.galleryItems[t.index].subHtml;
                                                if (subhtml && subhtml !== "") {
                                ...
                                // Keep hide timer alive while mouse is over the toast container
                                t._lgToastHoverHandler = function() {
                                    resetHideTimer();
                                };
                                document.getElementById("bottomCenterToastContainer").addEventListener("mousemove", t._lgToastHoverHandler);
                ...
                s.prototype.addHtml = function(t) {
                    ...
                    // console.log(this.galleryItems[t])
                    if (typeof shashin !== 'undefined') {
                        let subhtml = this.galleryItems[t].subHtmlUrl ? s = this.galleryItems[t].subHtmlUrl : e = this.galleryItems[t].subHtml;
                        if (subhtml && subhtml !== "") {
                            var _t = this, _idx = t;
                            var _showToast = function() {
                                if (shashin.hasToast(shashin.toast.placement.bottom.center, {tag: "lgSubhtml"}) === false) {
                                    shashin.showToastMessage(null, subhtml, {
                                        tag: "lgSubhtml",
                                        autohide: false,
                                        closeButton: false
                            ...
                            if (_t.lGalleryOn) {
                                ...
                                setTimeout(_showToast, 0);
                            }
                        }
                    }

                    if (this.galleryItems[t].subHtmlUrl ? s = this.galleryItems[t].subHtmlUrl : e = this.galleryItems[t].subHtml,
                        !s)
                        if (e) {
                    ...
                    if (".lg-item" !== this.settings.appendSubHtmlTo)
                        s ? this.outer.find(".lg-sub-html").load(s) : this.outer.find(".lg-sub-html").html(e);
                    else {
                ...
                s.prototype.getDummyImageContent = function(t, e, s) {
                    ...
                    if (this.settings.dynamic || (n = i(this.items).eq(e)),
                        n) {
                        var o = void 0;
                        if (!(o = this.settings.exThumbImage ? n.attr(this.settings.exThumbImage) : n.find("img").first().attr("src")))
                            return "";
                ...
                s.prototype.loadContent = function(t, e) {
                    ...
                    if (!r.hasClass("lg-loaded")) {
                        if (w) {
                            ...
                            L = this.calculateFullscreen(t, L);
                        ...
                        } else if (this.setImgMarkup(y, r, t),
                        u || f) {
                    ...
                    var B = 0
                        , P = 0;
                    this.lGalleryOn || (P = this.zoomFromOrigin && this.currentImageSize ? this.settings.startAnimationDuration + 10 : this.settings.backdropDuration + 10),
                    P && !i(document.body).hasClass("lg-from-hash") && (B = P),
                    !this.lGalleryOn && this.zoomFromOrigin && this.currentImageSize && (setTimeout((function() {
                            r.removeClass("lg-start-end-progress lg-start-progress").removeAttr("style")
                        }
                    ), this.settings.startAnimationDuration + 100),
                    r.hasClass("lg-loaded") || setTimeout((function() {
                            if (r.find(".lg-img-wrap").append(a(t, y, "", u, m, n.sources)),
                            u || f) {
                    ...
                    this.zoomFromOrigin && this.currentImageSize || !r.hasClass("lg-complete_") || this.lGalleryOn || setTimeout((function() {
                        ...
                        this.lGalleryOn = !0,
                    !0 === e && (r.hasClass("lg-complete_") ? this.preload(t) : r.find(".lg-object").first().on("load.lg error.lg", (function() {
                            s.preload(t)
                        }
                    )))
                }
                ...
                s.prototype.slide = function(t, e, i, s) {
                    ...
                    if (this.currentItemsInDom = this.organizeSlideItems(t, r),
                    !this.lGalleryOn || r !== t) {
                    ...
                    "lg-slide" !== this.settings.mode && this.outer.addClass("lg-slide"),
                        setTimeout((function() {
                                ...
                                if ("horizontal" === o.swipeDirection) {
                                    ...
                                    n < 0 && l > o.settings.swipeThreshold ? (o.goToNextSlide(!0),
                                        r = !1) : n > 0 && l > o.settings.swipeThreshold && (o.goToPrevSlide(!0),
                                        r = !1)
                                } else if ("vertical" === o.swipeDirection) {
                                    if (n = Math.abs(t.pageY - e.pageY),
                ...
                s.prototype.enableSwipe = function() {
                    ...
                    this.settings.enableSwipe && (this.$inner.on("touchstart.lg", (function(s) {
                            ...
                            !i(s.target).hasClass("lg-item") && !n.get().contains(s.target) || t.outer.hasClass("lg-zoomed") || t.lgBusy || 1 !== s.targetTouches.length || (o = !0,
                                t.touchAction = "swipe",
                                t.manageSwipeClass(),
                                e = {
                ...
                s.prototype.enableDrag = function() {
                    ...
                    this.settings.enableDrag && (this.outer.on("mousedown.lg", (function(s) {
                            ...
                            (i(s.target).hasClass("lg-item") || o.get().contains(s.target)) && (t.outer.hasClass("lg-zoomed") || t.lgBusy || (s.preventDefault(),
                        ...
                        i(window).on("mouseup.lg.global" + this.lgId, (function(r) {
                                if (t.lgOpened) {
                                    ...
                                    o ? (o = !1,
                                        t.touchEnd(s, e, r),
                                        t.LGel.trigger(D)) : t.isPosterElement(l) && t.LGel.trigger(E),
                                    n && (n = !1,
                ...
                s.prototype.goToNextSlide = function(t) {
                    ...
                    if (typeof shashin !== 'undefined') {
                        let subhtml = this.galleryItems[this.index].subHtmlUrl ? this.galleryItems[this.index].subHtmlUrl : this.galleryItems[this.index].subHtml;

                        if (subhtml && subhtml !== "" && shashin.hasToast(shashin.toast.placement.bottom.center, {tag: "lgSubhtml"}) === false) {
                            shashin.showToastMessage(null, subhtml, {
                                tag: "lgSubhtml",
                                autohide: false,
                                closeButton: false
                ...
                s.prototype.keyPress = function() {
                    ...
                    i(window).on("keydown.lg.global" + this.lgId, (function(e) {
                        if (27 === e.keyCode && $('#propMetadata').hasClass('show') === true && $("#metadataModalCancel").length > 0) {
                            e.preventDefault(); // press esc to close info modal
                            $('#propMetadata').modal({keyboard: true});
                            if (t.outer.hasClass("lg-components-open") === true) {
                                shashin.openedInfoFromLG = false;
                            }
                            $("#metadataModalCancel").click();
                        } else {
                            shashin.openedInfoFromLG === false && 27 === e.keyCode && t.lgOpened && !0 === t.settings.escKey && (e.preventDefault(),
                                t.settings.allowMediaOverlap && t.outer.hasClass("lg-can-toggle") && t.outer.hasClass("lg-components-open") ? t.outer.removeClass("lg-components-open") : shashin.openedInfoFromLG = true, $('#propMetadata').modal({
                                keyboard: true
                            }), t.closeGallery()),
                            t.lgOpened && t.galleryItems.length > 1 && (37 === e.keyCode && (e.preventDefault(),
                                ...
                                39 === e.keyCode && (e.preventDefault(),
                                    t.goToNextSlide()),
                                73 === e.keyCode && $('#propMetadata').hasClass('show') === false && $("#metadataDetail").length > 0 && (e.preventDefault(), // press i to bring up info modal
                                    $("#metadataDetail").click()),
                                27 === e.keyCode && shashin.openedInfoFromLG === true && $("#metadataDetail").length > 0 && (e.preventDefault(), // press i to bring up info modal
                                    shashin.openedInfoFromLG = false,$('#propMetadata').modal({keyboard: true}), $("#metadataModalCancel").click())
                            )
                        }
                    }))
                }
                ...
                s.prototype.mousewheel = function() {
                    ...
                    this.outer.on("mousewheel.lg", (function(e) {
                            !e.deltaY || t.galleryItems.length < 2 || (e.deltaY > 0 ? t.goToPrevSlide() : t.goToNextSlide(),
                                e.preventDefault())
                        }
                    ))
                }
                ...
                s.prototype.invalidateItems = function() {
                    if (typeof shashin !== 'undefined' && !this.lgOpened) {
                        shashin.closeToastMessages({tags:["subhtml", "lgSubhtml", "shashinSubhtml"]});
                    }
                ...
                s.prototype.destroyModules = function(t) {
                    this.plugins.forEach((function(e) {
                            try {
                                ...
                                const closeGalleryMsg = "lightGallery:- make sure lightGallery module is properly destroyed";
                                if (typeof shashin !== 'undefined') {
                                    shashin.printMessageToConsole(closeGalleryMsg, {
                                        consoleType: shashin.consoleTypes.error,
                                        tag: "lightgallery"
                                    });
                                } else {
                                    console.warn(closeGalleryMsg);
                                }
                            }
                        }
                    ))
