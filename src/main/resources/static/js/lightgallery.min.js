            ...
            return s.prototype.generateSettings = function(e) {
                ...
                s.prototype.hideBars = function() {
                    ...
                    setTimeout((function() {
                            ...
                            t.settings.hideBarsDelay > 0 && (t.outer.on("mousemove.lg click.lg touchstart.lg", (function() {
                                    setTimeout(function () {
                                        if (typeof shashin !== 'undefined' && shashin.hasToast(shashin.toast.placement.bottom.center, {tag: "subhtml"}) === false && t.lgOpened && t.galleryItems.length > 0) {
                ...
                s.prototype.addHtml = function(t) {
                    ...
                    if (typeof shashin !== 'undefined') {
                        ...
                        if (subhtml && subhtml !== "" && shashin.hasToast(shashin.toast.placement.bottom.center, {tag: "subhtml"}) === false) {
                            shashin.showToastMessage(null, subhtml, {
                                tag: "subhtml",
                                autohide: false,
                                closeButton: false
