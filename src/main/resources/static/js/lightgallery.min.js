            ...
            return s.prototype.generateSettings = function(e) {
                ...
                s.prototype.hideBars = function() {
                    ...
                    setTimeout((function() {
                            ...
                            t.settings.hideBarsDelay > 0 && (t.outer.on("mousemove.lg click.lg touchstart.lg", (function() {
                                    setTimeout(function () {
                                        if (typeof shashin !== 'undefined' && t.openToast === false && t.lgOpened && t.galleryItems.length > 0) {
                                            ...
                                            if (subhtml && subhtml !== null && subhtml !== "") {
                                                shashin.closeToastMessages({tags:["subhtml"]});
                ...
                s.prototype.addHtml = function(t) {
                    ...
                    if (typeof shashin !== 'undefined') {
                        ...
                        if (subhtml && subhtml !== null && subhtml !== "" && this.openToast === false) {
                            shashin.closeToastMessages({tags:["subhtml"]});
                            shashin.showToastMessage(null, subhtml, {
                                tag: "subhtml",
                                autohide: false,
