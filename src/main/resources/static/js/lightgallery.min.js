                ...
                s.prototype.openGalleryOnItemClick = function() {
                    for (var t = this, s = function(s) {
                        var o = n.items[s]
                            , r = i(o)
                            , l = e.generateUUID();
                        if (r.attr("data-metadata-id") !== "" && document.getElementById("mediaLink"+r.attr("data-metadata-id")).hasAttribute("data-lg-id") === false) {
                        ...
                        } else if (r.attr("data-metadata-id") !== "" && document.getElementById("mediaLink"+r.attr("data-metadata-id")).hasAttribute("data-lg-id") === true) {
                            l = r.attr("data-lg-id");
                            r.attr("data-lg-id", l).on("click.lgcustom-item-" + l, (function (e) {
                                    e.preventDefault();
                                    var i = t.settings.index || s;
