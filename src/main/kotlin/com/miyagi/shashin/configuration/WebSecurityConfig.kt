    ...
    override fun configure(http: HttpSecurity) {
        http
            ...
            .headers().frameOptions().sameOrigin()
                .and()
            .authorizeRequests()
                .antMatchers("/", "/features.html", "/css/**", "/js/**", "/fonts/**", "/images/**", "/users/register", "/users/login", "/users/logout", "/websocket-endpoint", "/topic/messages", "/settings/scanmessage").permitAll()
                ...
                .antMatchers("comments/**", "albums", "api/**", "map/**", "search/**").hasAnyRole(userRole.toString().replace("ROLE_", ""), adminRole.toString().replace("ROLE_", ""))
