    ...
    override fun configure(http: HttpSecurity) {
        http
            ...
            .headers()
                ...
                .and()
            .authorizeRequests()
                .antMatchers("/", "/docs/**", "/articles/**", "/health", "/features", "/api/**", "/share/**", "/css/**", "/js/**", "/fonts/**", "/images/**", "/users/register", "/users/login", "/users/logout", "/websocket-endpoint", "/topic/messages", "/topic/matchmessages", "/settings/matchmessage", "/settings/scanmessage","/dashboard/statmessages","/dashboard/statmessage").permitAll()
