...
//        println(event.message)
    ...
    @RequestMapping(value = ["/person/matches/start"], method = [RequestMethod.POST], consumes = ["application/json"], produces = ["application/json"])
    @Secured("ROLE_ADMIN")
    @ResponseBody
...
//            faceRecognizer.runRecognizer(shouldStop.get())
    ...
    @RequestMapping(value = ["/person/recognition/recognize/{metadataId}"], method = [RequestMethod.GET], consumes = ["application/json"], produces = ["application/json"])
    @Secured("ROLE_ADMIN")
    @ResponseBody
